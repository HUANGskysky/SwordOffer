package com.tinymood.jdsa.algorithm.sort;
...
public class SortPerformanceTest {
	...
	public static void main(String[] args) {
		...
		Long quickSortTime = new SortPerformanceTest().quickSortPerformance();
		System.out.println(MAX_SIZE + "组随机数据快速排序耗时：" + quickSortTime + "ms");
	...
	// 6.快排时间测试
	private Long quickSortPerformance() {
		int[] a = readBenchMark();
		Long start = System.currentTimeMillis();
